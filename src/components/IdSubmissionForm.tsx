  ...
  return (
    <form className="flex flex-row w-full" onSubmit={handleSubmit}>
      <div className="flex flex-col items-center gap-4 w-full">
        <label
          htmlFor="recipientId"
          className="font-cinzel text-[#efda9b] text-lg font-medium"
        >
        ...
        <div className="flex w-full gap-2">
          <input
            ...
            type="text"
            id="recipientId"
            placeholder="Write your Recipient ID"
          ...
          />
          <LoadingButton className="custom-button px-4 py-3" loading={pending}>
            Submit
          </LoadingButton>
        </div>
      </div>
